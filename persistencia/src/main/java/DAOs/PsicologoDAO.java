...
public class PsicologoDAO implements IPsicologoDAO {
    ...
    public List<Psicologo> obtenerPsicologos() throws PersistenciaException {
        try {
            ...
            lista.add(new Psicologo(null, "Jose", "Rodriguez", "Gaxiola", "jose@gmail.com", "FUNK671228PH6"));
            lista.add(new Psicologo(null, "Jorge", "Blanco", "Verdugo", "jorge@gmail.com", "FUNK671228PH6"));
            lista.add(new Psicologo(null, "Maria", "Felix", "Perez", "erikalucia005@gmail.com", "FUNK671228PH6"));
            return lista;
        } catch (Exception e) {
    ...
    public Psicologo obtenerPsicologoPorIdentificador(String identificador) throws PersistenciaException {
        try {
            return new Psicologo(null, "Abraham", "Sainz", "Felix", "jsusAbhram@potros.itson.com", "FUNK671228PH6");
        } catch (Exception e) {
